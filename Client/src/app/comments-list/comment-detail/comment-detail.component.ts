...
export class CommentDetailComponent implements OnInit {
  // todo ai check if you need | null. probably not
  ...
  // todo ai you should choose single approach (use public access modifiers or not)
  ...
  addReplyToComment(commentId: string): void {
    // todo ai format files in frontend?
